namespace SoppingCartStore.Web
{
    ...
    {
        private const string DefaultAdminPassword = "superadmin";
        ...
        static IEnumerable<CreateProductBindingModel> GetPreconfiguredProducts()
        {
            return new List<CreateProductBindingModel>()
            {
                ...
                new CreateProductBindingModel() { Name = "Panasonic HD W180", Price = 499.99M, CategoryId = "1c2453a3-0ca7-4c55-a4a4-baeaa4843a38", BrandId = "3ce3e570-bdeb-475a-be70-1b317158e622", Description = "Moving beyond its new design, additional enhancements and improvements in the Panasonic W180 include wireless charging capabilities, a faster 10-nanometer, six-core A11 Bionic processor that offers higher performance while utilizing less power, an all-glass body, a front-facing camera that's integrated into the display.", ImageURI = "https://images-na.ssl-images-amazon.com/images/I/81HNmRKDlmL._AC_SX522_.jpg" },
